...
class User extends Authenticatable
{
    ...
    public function isValidPhoneNumber()
    {
        ...
        // Returns true if the phone number matches any of the valid prefixes, otherwise false
...
{
    // Get the extension of the filename and convert it to lowercase
    $extension = strtolower(pathinfo($filename, PATHINFO_EXTENSION));

    $allowedExtensions = ['jpg', 'jpeg', 'png', 'gif','svg','webp','bmp'];

    //if the passed extension is in the allowed extensions array, return true, otherwise return false
